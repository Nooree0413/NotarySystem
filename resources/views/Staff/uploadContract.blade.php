...
<form method="POST" action="{{ route('upload.contract.submit') }}" id="frmAddUser" enctype="multipart/form-data">
    @csrf
    ...
    <li><a href="/staff/view/contract/{{$transaction->id}}" style="color:black;" target='_blank'>{{$transaction->name}}</a></li>
